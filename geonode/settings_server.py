...
SITE_HOST_NAME = os.getenv('SITE_HOST_NAME', 'homologageo.cnpm.embrapa.br')
...
try:
    ...
    # fallback to regular list of values separated with misc chars
    ALLOWED_HOSTS = [HOSTNAME, 'localhost', 'django', 'geonode', '192.168.15.83', '192.168.15.124','192.168.15.157','hdnembrapa.ddns.net','hdnembrapa.ddns.net:8000','homologageo.cnpm.embrapa.br','200.136.111.99'] if os.getenv('ALLOWED_HOSTS') is None \
